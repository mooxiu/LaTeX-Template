...
\addtobeamertemplate{frametitle}{}{
    \begin{textblock*}{100mm}(0.70\textwidth,-0.82cm)
        \includegraphics[height=0.65cm]{~/Documents/workspace/LaTeX-Template/Beamer/Figures/logo/isct_logo_inverse.png}
    \end{textblock*}}

% Reference: https://design-system.isct.ac.jp/ja/brand/elements/color/color-system 
\definecolor{themecolor}{RGB}{28,49,119}
% \definecolor{backgroundcolor}{RGB}{232,234,241}
...
% \titlegraphic{\includegraphics[height=1.3cm]{~/Documents/workspace/LaTeX-Template/Beamer/Figures/logo/logo2.png}}
% \titlegraphic{\includegraphics[height=1.3cm]{~/Documents/workspace/LaTeX-Template/Beamer/Figures/logo/isct_logo.png}}